...
class PositionObserverTarget {
    ...
    oninterception([entry], observer){
        ...
        if( this.isReset && ( ( this.isVisible && ( !entry.isIntersecting || !hasMargin) ) || ( !this.isVisible && hasMargin ) ) ){
    ...
    resetObserver( targetRect ){
        ...
        if(this.isVisible){
            const margin = ObserveTools.rootMarginFromRect( { width: window.innerWidth, height: window.innerHeight }, targetRect );
